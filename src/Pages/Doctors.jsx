...
const Doctors = () => {
    ...
    return (
        <section className='allDoctorsPage'>
            <p className='section-subTitle'>Browse through the doctors specialist.</p>
            <div className='allDoctors'>

                {/* -----------Left--------------- */}
                <div className='left'>
                    <span className='section-subTitle filter' onClick={() => showSpeciality()}>Filter</span>
                    <div className='showFilterSpeci'>
                        <Link to={`/doctors`} id='all' onClick={() => showSpeciality()}>
                            <span className='section-subTitle '>All</span>
                        </Link>
